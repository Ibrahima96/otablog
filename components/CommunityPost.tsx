...
import { Heart, MessageCircle, ShoppingBag, Image as ImageIcon, Video, Tag, Trash2 } from 'lucide-react';
...
const CommunityPost: React.FC<CommunityPostProps> = ({ post, onDelete }) => {
    ...
    return (
        ...
        >
            ...
            <div className="relative aspect-square bg-gradient-to-br from-neonPurple/10 to-electricBlue/10 flex items-center justify-center overflow-hidden">
                ...
                {isOwnPost && (
                    <button
                        ...
                        disabled={isDeleting}
                        className="absolute top-3 left-3 p-2 bg-red-500/80 hover:bg-red-600 backdrop-blur-sm rounded-full border border-white/20 text-white transition-all opacity-0 group-hover:opacity-100"
                        title="Supprimer"
                    >
                        <Trash2 size={16} />
                    </button>
