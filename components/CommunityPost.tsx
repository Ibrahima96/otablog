                        ...
                        <div className="mb-3 p-3 bg-neonPink/5 border border-neonPink/20 rounded-lg">
                            ...
                            <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {post.content.marketplaceItem.whatsappNumber && (
                                    <a
                                        href={`https://wa.me/${post.content.marketplaceItem.whatsappNumber.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(`Bonjour! Je suis intéressé(e) par "${post.content.marketplaceItem.title}" à ${post.content.marketplaceItem.price} ${post.content.marketplaceItem.currency}`)}`}
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        onClick={(e) => e.stopPropagation()}
                                        className="inline-flex items-center gap-1.5 text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded-full border border-green-500/30 font-mono hover:bg-green-500/30 transition-colors"
                                    >
